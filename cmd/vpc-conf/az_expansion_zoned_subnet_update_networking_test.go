...
type AZExpansionZonedSubnetUpdateNetworking struct {
	TestCaseName string
...
func TestPerformAZExpansionZonedSubnetUpdateNetworking(t *testing.T) {
	ExistingSubnetCIDRs := map[string]string{
		"subnet-0d6f71ecc209c3ded": "10.223.194.160/28",
		"subnet-0b0facc12683f76f1": "10.147.105.96/27",
		"subnet-08c85851cd535a97f": "10.223.201.192/28",
		"subnet-059e2b3a6942e4744": "10.147.105.64/27",
	...
	endStateJson := `
{
 ...
 "RouteTables": {
  ...
  "rtb-01b19cf75c755519a": {
   "Routes": [
    {
     "Destination": "0.0.0.0/0",
     "NATGatewayID": "nat-09c56feb4f276dd02",
     "InternetGatewayID": "",
     "TransitGatewayID": "",
     "PeeringConnectionID": "",
     "VPCEndpointID": ""
    ...
    "Data": [
     {
      "SubnetID": "subnet-08c85851cd535a97f",
      "GroupName": "data",
      "RouteTableAssociationID": "rtbassoc-0c81b91552ba1b474",
      "CustomRouteTableID": "rtb-01b19cf75c755519a"
     }
    ],
    "Private": [
     {
      "SubnetID": "subnet-059e2b3a6942e4744",
      "GroupName": "private",
      "RouteTableAssociationID": "rtbassoc-0551ba8a12099afe6",
      "CustomRouteTableID": ""
     }
    ],
    "Public": [
     {
      "SubnetID": "subnet-0b0facc12683f76f1",
      "GroupName": "public",
      "RouteTableAssociationID": "rtbassoc-060494684b246d614",
      "CustomRouteTableID": ""
     }
    ]
   },
   "PrivateRouteTableID": "rtb-04e8213290bb3129a",
   "PublicRouteTableID": "",
   "NATGateway": {
    "NATGatewayID": "nat-09c56feb4f276dd02",
    "EIPID": "eipalloc-0627bd2dfe520a82c"
   }
  }
 },
 "TransitGatewayAttachments": null,
...
`
	...
	preDefinedNatGatewayIDQueue := []string{
		"nat-09c56feb4f276dd02"}
	preDefinedRouteTableIDQueue := []string{
		"rtb-04e8213290bb3129a", "rtb-01b19cf75c755519a", "rtb-c"}
	preDefinedRouteTableAssociationIDQueue := []string{
		"rtbassoc-06df726a819203f39", "rtbassoc-03c9924b69043dd86", "rtbassoc-060494684b246d614", "rtbassoc-0551ba8a12099afe6", "rtbassoc-0c81b91552ba1b474"}
	preDefinedEIPQueue := []string{
		"eipalloc-0627bd2dfe520a82c"}
	...
	ExistingVPCCIDRBlocks := []*ec2.VpcCidrBlockAssociation{
		...
		{
			AssociationId: aws.String("vpc-cidr-assoc-076a4ceeecb65fd2d"),
		...
		{
			AssociationId: aws.String("vpc-cidr-assoc-0418f23b10b8890fa"),
			CidrBlock:     aws.String("10.223.201.192/28"),
			CidrBlockState: &ec2.VpcCidrBlockState{
				State: aws.String("associated"),
			},
		},
	...
	tc := AZExpansionZonedSubnetUpdateNetworking{
