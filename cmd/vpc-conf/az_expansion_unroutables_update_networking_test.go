...
type AZExpansionUnroutablesUpdateNetworking struct {
	TestCaseName string
...
func TestPerformAZExpansionUnroutablesUpdateNetworking(t *testing.T) {
	ExistingSubnetCIDRs := map[string]string{
		"subnet-0cdc7f1df250c7a40": "100.71.128.0/17",
		"subnet-068e6a602fc3aaea6": "10.147.105.96/27",
		"subnet-0d47ac3b4a324228e": "10.147.105.64/27",
		...
		"subnet-0215d7a70bac433f8": "100.68.0.0/16",
	}
	...
	endStateJson := `
{
 ...
 "RouteTables": {
  ...
  "rtb-049762a6ff64e5218": {
   "Routes": [
    {
     "Destination": "0.0.0.0/0",
     "NATGatewayID": "nat-0e8e026953a430a1a",
     "InternetGatewayID": "",
     "TransitGatewayID": "",
     "PeeringConnectionID": "",
     "VPCEndpointID": ""
    ...
    "Private": [
     {
      "SubnetID": "subnet-0d47ac3b4a324228e",
      "GroupName": "private",
      "RouteTableAssociationID": "rtbassoc-0dda95e6e9f8ed25f",
      "CustomRouteTableID": ""
     }
    ],
    "Public": [
     {
      "SubnetID": "subnet-068e6a602fc3aaea6",
      "GroupName": "public",
      "RouteTableAssociationID": "rtbassoc-0452d6f2bf05ba0c0",
      "CustomRouteTableID": ""
     }
    ],
    "Unroutable": [
     {
      "SubnetID": "subnet-0215d7a70bac433f8",
      "GroupName": "unroutable",
      "RouteTableAssociationID": "rtbassoc-0bbb86f318a0f9ab1",
      "CustomRouteTableID": "rtb-049762a6ff64e5218"
     }
    ]
   },
   "PrivateRouteTableID": "rtb-0ac098c2a795c7c5f",
   "PublicRouteTableID": "",
   "NATGateway": {
    "NATGatewayID": "nat-0e8e026953a430a1a",
    "EIPID": "eipalloc-0d265186f86a7ac02"
   }
  }
 },
 "TransitGatewayAttachments": null,
...
`
	...
	preDefinedNatGatewayIDQueue := []string{
		"nat-0e8e026953a430a1a"}
	preDefinedRouteTableIDQueue := []string{
		"rtb-0ac098c2a795c7c5f", "rtb-049762a6ff64e5218"}
	preDefinedRouteTableAssociationIDQueue := []string{
		"rtbassoc-0b4a9802a114818d7", "rtbassoc-084618e6405e08a59", "rtbassoc-0452d6f2bf05ba0c0", "rtbassoc-0dda95e6e9f8ed25f", "rtbassoc-0bbb86f318a0f9ab1"}
	preDefinedEIPQueue := []string{
		"eipalloc-0d265186f86a7ac02"}
	...
	ExistingVPCCIDRBlocks := []*ec2.VpcCidrBlockAssociation{
		...
		{
			AssociationId: aws.String("vpc-cidr-assoc-010dd0a012e4ad1c7"),
		...
		{
			AssociationId: aws.String("vpc-cidr-assoc-0d3c075faa1e94957"),
	...
	tc := AZExpansionUnroutablesUpdateNetworking{
