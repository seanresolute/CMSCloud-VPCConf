...
type AZExpansion2to3UpdateNetworking struct {
	TestCaseName string
...
func TestPerformAZExpansion2to3UpdateNetworking(t *testing.T) {
	ExistingSubnetCIDRs := map[string]string{
		"subnet-014f9cfc075b16f5a": "10.147.51.32/27",
		"subnet-0735b030d92cdf6b2": "10.147.105.64/27",
		"subnet-0c27d6714dda2ddba": "10.147.105.96/27",
	...
	endStateJson := `
{
 ...
 "RouteTables": {
  ...
  "rtb-0ad257b6ba6b9943d": {
   "Routes": [
    {
     "Destination": "0.0.0.0/0",
     "NATGatewayID": "nat-0d0f4db716107b368",
     "InternetGatewayID": "",
     "TransitGatewayID": "",
     "PeeringConnectionID": "",
     "VPCEndpointID": ""
    ...
    "Private": [
     {
      "SubnetID": "subnet-0735b030d92cdf6b2",
      "GroupName": "private",
      "RouteTableAssociationID": "rtbassoc-02bdc265cb7f916ba",
      "CustomRouteTableID": ""
     }
    ],
    "Public": [
     {
      "SubnetID": "subnet-0c27d6714dda2ddba",
      "GroupName": "public",
      "RouteTableAssociationID": "rtbassoc-0d385e018eb3400e3",
      "CustomRouteTableID": ""
     }
    ]
   },
   "PrivateRouteTableID": "rtb-0ad257b6ba6b9943d",
   "PublicRouteTableID": "",
   "NATGateway": {
    "NATGatewayID": "nat-0d0f4db716107b368",
    "EIPID": "eipalloc-0e858dd60327a1a64"
   }
  }
 },
 "TransitGatewayAttachments": null,
...
`
	...
	preDefinedNatGatewayIDQueue := []string{
		"nat-0d0f4db716107b368"}
	preDefinedRouteTableIDQueue := []string{
		"rtb-0ad257b6ba6b9943d"}
	preDefinedRouteTableAssociationIDQueue := []string{
		"rtbassoc-046cd46139085e4d4", "rtbassoc-053005446ab709bed", "rtbassoc-0d385e018eb3400e3", "rtbassoc-02bdc265cb7f916ba"}
	preDefinedEIPQueue := []string{
		"eipalloc-0e858dd60327a1a64"}
	...
	ExistingVPCCIDRBlocks := []*ec2.VpcCidrBlockAssociation{
		...
		{
			AssociationId: aws.String("vpc-cidr-assoc-05346797bb86cdc68"),
	...
	tc := AZExpansion2to3UpdateNetworking{
