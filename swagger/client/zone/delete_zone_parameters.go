...
type DeleteZoneParams struct {
	...
	/*DeleteParameters
	  The input describing the zone to be deleted. The following parameters are required: domainName, domainType (when not 'Default'), server, view (when not 'Default').

	*/
	DeleteParameters DeleteZoneBody
...
// WithDeleteParameters adds the deleteParameters to the delete zone params
func (o *DeleteZoneParams) WithDeleteParameters(deleteParameters DeleteZoneBody) *DeleteZoneParams {
	o.SetDeleteParameters(deleteParameters)
	return o
}

// SetDeleteParameters adds the deleteParameters to the delete zone params
func (o *DeleteZoneParams) SetDeleteParameters(deleteParameters DeleteZoneBody) {
